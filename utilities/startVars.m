...
%defining my bus used in imageprocessing block
% Your custom bus definition
elems(1) = Simulink.BusElement;
elems(1).Name = 'Land_it';
elems(1).DataType = 'boolean';

elems(2) = Simulink.BusElement;
elems(2).Name = 'Allleft';
elems(2).DataType = 'double';

elems(3) = Simulink.BusElement;
elems(3).Name = 'Allright';
elems(3).DataType = 'double';

elems(4) = Simulink.BusElement;
elems(4).Name = 'DegAngle';
...
Precision = 2;
vel=4.5e-4;
xout = Simulink.Signal;
yout = Simulink.Signal;
zout = Simulink.Signal;
